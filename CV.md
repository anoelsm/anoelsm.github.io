...
<div style="text-align: center;">
	<a href="https://twitter.com/phytoplasmith" class="icon fa-twitter fa-4x"><span class="label">Twitter</span></a>
	<a href="https://instagram.com/theofficialalainasmith" class="icon fa-instagram fa-4x"><span class="label">Instagram</span></a>
	<a href="https://github.com/anoelsm" class="icon fa-github fa-4x"><span class="label">Github</span></a>
	<a href="https://linkedin.com/alaina-noel-smith" class="icon fa-linkedin-square fa-4x"><span class="label">LinkedIn</span></a>
</div>
